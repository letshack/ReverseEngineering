...
%
    OutfileStart = 'C:/Users/BALAJIS/Workgali',
...
rule1(OldXmi, NewXmi) :-
	...
	splitTempXmi(OldXmi, TopTags, UmlModelTags, UnsortedKids,
				  ...
				  SecurityClientDep, SecurityKids, /*add here, suppose add two more parameters: SecurityClientDep and SecurityKids...................................................*/
...
%			      ControllerClientDep, ControllerKids),
	...
	rule1Component(security, UnsortedKids3, SecurityClientDep, SecurityKids, InterfaceList3, /*%add new rule1Compoenent for security..................................*/
		   UnsortedKids4, NewSecurityClientDep, NewSecurityKids, InterfaceList4),
...
%	/* change!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
	...
	buildTempXmi(NewXmi, TopTags, UmlModelTags,
		UnsortedKids4, %change UnsortedKids3 to UnsortedKids4
		NewAspectKids,
		NewModelClientDep, NewModelKids,
		NewViewClientDep, NewViewKids,
		NewControllerClientDep, NewControllerKids,
		NewSecurityClientDep, NewSecurityKids, %add new parameter for security here...................................................
		InterfaceList4, %change InterfaceList3 to InterfaceList4
		AspectElements).
...
/*
	...
	append(AccInterfaceList,
	       [element(packagedElement,
			['xmi:type'='uml:Interface',
			 'xmi:id'=HeadId,
			 visibility=' (public)', %change public to ' (public)'...........................................................
			 name=HeadName],
			HeadKids)],
	      NewAccInterfaceList),
	% end
...
rule1ComponentMatch(ComponentType, element(packagedElement, _, ElementKids)) :-
	...
	member(visibility=' (public)', OperationTags), %change public to ' (public)'
...
rule1operation(controller, doNothing).
/* add rule1operation for security, just copy paste from contorller see it works or not.....................................................................*/
rule1operation(security, mouseMove).
rule1operation(security, mouseDown).
rule1operation(security, mouseDrag).
rule1operation(security, mouseUp).
rule1operation(security, doNothing).
...
rule2(OldXmi, NewXmi) :-
	...
	splitTempXmi(OldXmi, TopTags, UmlModelTags, UnsortedKids0,
			      ...
			      ViewClientDep, ViewKids,
			      ControllerClientDep, ControllerKids,
				  SecurityClientDep, SecurityKids, %add here.................................................
	...
	rule2Component(controller, UnsortedKids2, ControllerClientDep, ControllerKids, InterfaceList2,
		       UnsortedKids3, NewControllerClientDep, NewControllerKids, InterfaceList3),
    rule2Component(security, UnsortedKids3, SecurityClientDep, SecurityKids, InterfaceList3, %add rul2Component for security......................................
		       UnsortedKids4, NewSecurityClientDep, NewSecurityKids, InterfaceList4),
	/* change!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
	...
	buildTempXmi(NewXmi, TopTags, UmlModelTags,
		...
		NewViewClientDep, NewViewKids,
		NewControllerClientDep, NewControllerKids,
		NewSecurityClientDep, NewSecurityKids, %&add here..................................................................
		InterfaceList4, %change InterfaceList3 to InterfaceList4...........................................................
		AspectElements).
...
extractComponentTerms(UmlModelComponents,
	...
	member(component(security, SecurityClientDep, SecurityKids), UmlModelComponents). %add here....................................................
...
buildTempXmi(NewXmi, TopTags, UmlModelTags,
	...
	NewUmlModelComponents = [component(unsorted, [], UnsortedKids),
				 ...
				 component(security, SecurityClientDep, SecurityKids)], %add here...............................................................
